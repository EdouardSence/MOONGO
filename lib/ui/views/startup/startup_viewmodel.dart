...
import 'package:moongo/services/streak_service.dart';
...
class StartupViewModel extends BaseViewModel {
  ...
  final _streakService = locator<StreakService>();
  ...
  Future runStartupLogic() async {
    ...
    authService.firebaseAuth.authStateChanges().listen((User? user) async {
      if (user != null) {
        ...
        if (hasProfile) {
          // Vérifier et mettre à jour la streak (basée sur minuit)
          await _streakService.checkAndUpdateStreak(user.uid);
